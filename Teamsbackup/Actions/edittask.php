      ...
      <h2 class="text-black text-lg text-center font-medium title-font mb-5">Update Task</h2>
       <?php
        ...
        <div class="relative mb-4">
            ...
            <input value='.$edittaskname.' required type="text" id="editedtaskname" name="editedtaskname" class="w-full bg-gray-200 rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
        ...
        <div class="  ">
        <button class="mx-auto  text-black bg-[#E5B8F4] border-0 py-2 px-8 focus:outline-none hover:bg-purple-500 rounded text-lg  " >UPDATE</button>
        </div>
