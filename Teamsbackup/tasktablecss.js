 ...
 */
 ...
 $.extend( true, DataTable.defaults, {
     dom:
         "<'grid grid-cols-1 md:grid-cols-2 text-black'" +
             "<'self-center'l>" +
             "<'self-center place-self-end'f>" +
             "<'my-2 col-span-2 border border-gray-200 rounded min-w-full bg-white dark:bg-white dark:border-gray-700'tr>" +
             "<'self-center'i>" +
 ...
 $.extend( DataTable.ext.classes, {
     ...
     sFilterInput:  "border placeholder-gray-500 ml-2 px-16 py-2 rounded-lg border-gray-200 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:bg-white dark:border-gray-600 dark:focus:border-blue-500 dark:placeholder-gray-400",
     sLengthSelect: "border px-3 py-2 rounded-lg border-gray-200 focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:bg-white dark:border-gray-600 dark:focus:border-blue-500",
     sProcessing:   "dt-processing uk-panel",
     tailwindcss: {
         paging: {
             active: 'font-semibold bg-gray-100 dark:bg-white',
             notActive: 'bg-white dark:bg-white',
             ...
             first: 'rounded-l-lg',
             last: 'rounded-r-lg',
             enabled: 'text-black hover:text-gray-900 hover:border-gray-300 hover:shadow-sm focus:ring focus:ring-gray-300 focus:ring-opacity-25 dark:text-black dark:hover:border-gray-600 dark:hover:text-gray-200 dark:focus:ring-gray-600 dark:focus:ring-opacity-40',
             notEnabled: 'text-gray-300 dark:text-black'
         },
         table: 'dataTable min-w-full text-sm  align-middle whitespace-nowrap',
         thead: {
             row: 'border-b border-black dark:border-black',
             cell: 'px-3 py-4 text-black  font-semibold text-left dark:text-black dark:bg-white '
         },
         tbody: {
             row: 'even:bg-white/90 dark:even:bg-white/90 ',
             cell: 'p-3'
         },
         tfoot: {
 ...
 DataTable.ext.renderer.pageButton.tailwindcss = function ( settings, host, idx, buttons, page, pages ) {
     ...
     if (paginationEl.length) {
         ...
         paginationEl = hostEl
             .html('<div class="text-center dark:text-white"/>')
             .children('div');
     }
